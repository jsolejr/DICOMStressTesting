REM File Name - StoreSCU-Folder-6 ALL.cmd
@ECHO OFF
...
START "LOADER" StoreSCU.exe -v --repeat 500000 +IP 1 +IS 2 +IR 100 -xi -aet STORESCU -aec %AE% %SCP% %PORT% ..\Images\KB032\*
SLEEP 1
START "LOADER" StoreSCU.exe -v --repeat 500000 +IP 1 +IS 2 +IR 100 -xi -aet STORESCU -aec %AE% %SCP% %PORT% ..\Images\KB128\*
SLEEP 1
START "LOADER" StoreSCU.exe -v --repeat 500000 +IP 1 +IS 2 +IR 100 -xi -aet STORESCU -aec %AE% %SCP% %PORT% ..\Images\KB256\*
SLEEP 1
START "LOADER" StoreSCU.exe -v --repeat 500000 +IP 1 +IS 2 +IR 100 -xi -aet STORESCU -aec %AE% %SCP% %PORT% ..\Images\KB512\*
SLEEP 1
START "LOADER" StoreSCU.exe -v --repeat 500000 +IP 1 +IS 2 +IR 100 -xi -aet STORESCU -aec %AE% %SCP% %PORT% ..\Images\MB01\*
